...
class ProductResourceIT {
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product().name(DEFAULT_NAME).code(DEFAULT_CODE);
        return product;
    }
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product().name(UPDATED_NAME).code(UPDATED_CODE);
        return product;
    }
    ...
    void putNewProduct() throws Exception {
        ...
        updatedProduct.name(UPDATED_NAME).code(UPDATED_CODE);
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.name(UPDATED_NAME).code(UPDATED_CODE);
